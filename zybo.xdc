...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }];  #IO_L24P_T3_34 Sch=SW1
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L4N_T0_34 Sch=SW2
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L9P_T1_DQS_34 Sch=SW3
...
##Pmod Header JB
set_property -dict {PACKAGE_PIN T20 IOSTANDARD LVCMOS33} [get_ports scl]
set_property -dict {PACKAGE_PIN U20 IOSTANDARD LVCMOS33} [get_ports sda]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports datain_rx]
